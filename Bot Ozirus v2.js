// ==UserScript==
// @name         1 - Bocik e2 - Ozirus [Neon UI + Memory + Position Fix]
...
(function() {
    ...
    const STORAGE_POS_KEY = 'bocik_ozirus_gui_pos'; // Nowy klucz do pozycji
    ...
    toggleButton.onclick = () => {
        isRunning = !isRunning;
        if (isRunning) {
            toggleButton.innerText = 'STOP (ON)'; toggleButton.className = 'bocik-btn btn-on'; statusText.innerText = 'Status: Szukam celu...';
        } else {
            toggleButton.innerText = 'START (OFF)'; toggleButton.className = 'bocik-btn btn-off'; statusText.innerText = 'Status: Zatrzymany';
        }
    };
    ...
    (function makeDraggable(element, dragHandle) {
        ...
        function closeDragElement() {
            ...
            // 2. Zapisz pozycję po zakończeniu ruchu
