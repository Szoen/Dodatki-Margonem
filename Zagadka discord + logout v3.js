// ==UserScript==
// @name         Zagadka discord v5.6 [Universal Fetch]
// @namespace    http://tampermonkey.net/
// @version      5.6
// @description  Wykrywa zagadkę, Panel Neon UI, Naprawione przesuwanie, Fetch zamiast GM_XHR
...
(function() {
    ...
    testBtn.onclick = () => {
        ...
        // ZMIANA: Używamy fetch zamiast GM_xmlhttpRequest
        ...
        .then(response => {
            if (response.ok) {
                ...
                alert("❌ Błąd Discorda: " + response.status);
            }
        })
        .catch(error => {
            console.error(error);
            alert("❌ Błąd sieci! Sprawdź konsolę (F12).");
        });
    };
