// ==UserScript==
// @name         Margonem Mob Detector v5.3 [Memory ON/OFF]
// @namespace    http://tampermonkey.net/
// @version      5.3
// @description  Wykrywa moby, Fetch (Discord), GUI Memory, ON/OFF Memory
...
(function() {
    ...
    // --- INTEGRACJA Z HUBEM ---
    const ADDON_ID = 'mob_detector';
    const STORAGE_VISIBLE_KEY = 'bocik_mob_gui_visible';
    const STORAGE_POS_KEY = 'bocik_mob_gui_pos';
    const STORAGE_RUNNING_KEY = 'bocik_mob_running'; // Nowy klucz do stanu ON/OFF
    ...
    // --- ZMIENNE STANU ---
    // Wczytujemy stan z pamięci przy starcie
    ...
    // Jeśli wczytano stan ON, ustaw przycisk na zielono od razu
    if (isRunning) {
