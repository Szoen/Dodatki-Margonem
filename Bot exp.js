// ==UserScript==
// @name         Bot Exp v36.2 [Hub Optimized]
// @namespace    http://tampermonkey.net/
// @version      36.2
// @description  Bot do expienia z naprawioną pętlą i integracją z Hubem (Neon Theme + Memory)
...
(function() {
    ...
    // --- INTEGRACJA Z HUBEM ---
    const ADDON_ID = 'bot_exp'; // To ID dodaj do REPOSITORY w Hubie
